...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'alice@wonderful.com', person_id: alice.id } }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'email@simple.com', person_id: bob.id} }
      let(:new_attributes) {
        { address: "newemail@newexample.com", person_id: bob.id}
      }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq('newemail@newexample.com')
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested email_address" do
      ...
      valid_attributes = {address: 'myemail@ohyeah.com', person_id: bob.id}
      email_address = EmailAddress.create! valid_attributes
      expect {
